...
public class A1_G5_t1 {
    public static void main(String[] args) {
        ...
        // Prepare the transactions for Apriori
        ...
        // Instantiate and use Apriori
        Apriori apriori = new Apriori(transactions, minsup);
        Map<Set<String>, Double> frequentItemsets = apriori.findFrequentItemsets();
        ...
        sortedItemsets.sort(Map.Entry.comparingByValue());
